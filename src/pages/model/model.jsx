        ...
        >
          <div className="py-3">
            ...
            <table>
              ...
              <tr>
                <td className="py-[2px]">Keterangan</td>
                <td className="py-[2px] px-3">:</td>
                <td className="py-[2px]">{DataModel[id].bio.keterangan} </td>
              </tr>
              <tr>
                <td className="py-[2px]">Isi</td>
                <td className="py-[2px] px-3">:</td>
                <td className="py-[2px]">{DataModel[id].bio.isi} Pcs</td>
              </tr>
