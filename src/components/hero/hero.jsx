  ...
  return (
    ...
    <section className="px-[1.32rem]">
      <h1 className="text-2xl font-semibold">
        ...
        HUBA BANDUNG <motion.span className="bg-[#fd8703] text-white px-1">#SEUHAHEUY!</motion.span>
        </motion.span>
        <motion.span  initial={{ opacity:0 }} animate={{ opacity:1, transition:{ delay:1, duration:.5} }}>
        , SEKALI COBA BIKIN NAGIH NIKMAT NYA !! <motion.span className="bg-[#fd8703] text-white px-1">HALALAN THAYYIBAN</motion.span>
        </motion.span>
      </h1>
      ...
      } className="bg-[#fd8703] w-fit py-3 px-[2.657rem] rounded-xl text-white font-semibold">Beli Sekarang</button>
        <p className="text-[#747474] text-sm">Pesen sekarang agar laper anda hilang !!</p>
      </div>
